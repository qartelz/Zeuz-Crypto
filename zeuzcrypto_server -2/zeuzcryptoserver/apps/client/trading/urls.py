...
from .views import (
    ...
    PnLReportView,
    TradeHistoryView,
    TradeDetailHistoryView,
    UpdatePricesView,
    RiskCheckView,
)
from .viewss.signal_views import (
    get_margin_status,
...
urlpatterns = [
    ...
    path(
        "close-trade/<uuid:trade_id>/",
        views.CloseTradeView.as_view(),
        name="close-trade",
    ),
    path(
        "partial-close/<uuid:trade_id>/",
        views.PartialCloseView.as_view(),
        name="partial-close",
    ),
    # Portfolio endpoints
    path(
    ...
    path(
        "portfolio/positions/",
        views.ActivePositionsView.as_view(),
    ...
    path(
        "trades/<uuid:trade_id>/history/",
        views.TradeDetailHistoryView.as_view(),
        name="trade-detail-history",
    ),
    # Market data
    ...
    path(
        "trades/<uuid:trade_id>/margin-status/", get_margin_status, name="margin-status"
    ),
