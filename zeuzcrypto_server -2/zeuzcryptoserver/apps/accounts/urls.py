...
from . import views
from .views import UserDetailWithTradesView, BatchUsersByB2BAdminView, BatchListByB2BAdminView
...
urlpatterns = [
    ...
    path('batches/by-b2b-admin/<uuid:b2b_admin_id>/', BatchListByB2BAdminView.as_view(), name='batches-by-b2b-admin'),
