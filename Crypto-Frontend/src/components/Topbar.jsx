...
const Topbar = ({ onToggleSidebar, sidebarOpen }) => {
  ...
  return (
    <div className="flex items-center justify-between px-4 sm:px-6 py-10 h-16 backdrop-blur-md border-b border-white/10 relative z-50">
      {/* Left Section */}
      ...
      <div className="flex items-center gap-6 text-white relative">
            ...
            {isloading ? (
              ...
              <>
                <div className="flex justify-between text-sm text-gray-300">
                  ...
                  <span
                    className={`${totalPnLPercentage >= 0 ? 'text-green-400' : 'text-red-400'
                      } `}
                  >
                ...
                <div className="flex items-center gap-1 mt-1">
                  <span
                    className={`font - bold text - base ${totalPnL >= 0 ? 'text-green-400' : 'text-red-400'
                      } `}
                  >
                    {totalPnL >= 0 ? '+' : ''}
        ...
        <div className="relative z-50" ref={dropdownRef}>
          ...
          {/* Dropdown Menu */}
          {dropdownOpen && (
            <div className="absolute z-50 backdrop-blur-lg right-0 mt-3 w-56 bg-[#1C1E2A] border border-gray-800 rounded-lg shadow-lg py-2">
